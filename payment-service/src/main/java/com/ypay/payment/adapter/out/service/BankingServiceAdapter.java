package com.ypay.payment.adapter.out.service;
...
import com.ypay.payment.application.port.out.RegisteredBankAccountAggregateIdentifier;
...
public class BankingServiceAdapter implements GetRegisteredBankAccountPort {
    ...
    public BankingServiceAdapter(CommonHttpClient commonHttpClient, @Value("${service.banking.url}") String membershipServiceUrl) {
